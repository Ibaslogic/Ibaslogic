    ...
    <section className="prose max-w-full">
      <div>
        <p>
          ...
          and conditions. Do not continue to use Ibaslogic if you do
        ...
        <p>
          Unless otherwise stated, https://ibaslogic.com/ and/or its
          licensors own the intellectual property rights for all
          material on Ibaslogic. All intellectual property rights are
          reserved. You may access this from Ibaslogic for your
        ...
        <ul>
          ...
          <li>
            Reproduce, duplicate or copy material from Ibaslogic
          </li>
        ...
        <p>
          ...
          the website (i.e the comments area). https://ibaslogic.com/
          does not filter, edit, publish or review Comments before
          their presence on the website. Comments do not reflect the
          views and opinions of https://ibaslogic.com/, its agents
          and/or affiliates. Comments reflect the views and opinions
          of the person who post their views and opinions. To the
          extent permitted by applicable laws, https://ibaslogic.com/
          shall not be liable for the Comments or any liability,
        ...
        <p>
          https://ibaslogic.com/ reserves the right to monitor all
        ...
        <p>
          You hereby grant https://ibaslogic.com/ a non-exclusive
        ...
        <p>
          ...
          publications or other Website information so long as the
        ...
        <p>
          ...
          inform us by sending an e-mail to https://ibaslogic.com/.
        ...
        <p>
          No use of https://ibaslogic.com/'s logo or other artwork
