const Privacy = () => {
  return (
    <section className="prose max-w-full">
      <div className="">
        <p>
          Here, one of our main priorities is the privacy of our
          visitors. This Privacy Policy document contains types of
          information that is collected and recorded by Ibaslogic and
          how we use it.
        </p>
        ...
        <p>
          ...
          information that they shared and/or collect in Ibaslogic.
        ...
        <p>
          Ibaslogic follows a standard procedure of using log files.
        ...
        <p>
          ...
          each of the advertising partners of Ibaslogic.
        </p>
        ...
        <p>
          ...
          Ibaslogic, which are sent directly to users' browser. They
        ...
        <p>
          Note that Ibaslogic has no access to or control over these
        ...
        <p>
          Ibaslogic's Privacy Policy does not apply to other
        ...
        <p>
          ...
          management with specific web browsers, it can be found at
        ...
        <p>
          ...
          of your data. We may charge you a small fee for this
          service.
        </p>
        <p>
        ...
        <p>
          Ibaslogic does not knowingly collect any Personal
