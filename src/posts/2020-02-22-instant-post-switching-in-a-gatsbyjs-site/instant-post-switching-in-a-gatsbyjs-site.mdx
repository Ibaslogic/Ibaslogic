...
Sometimes, you just want to give your audience the ease to interact with your post.
...
_If you are using the [official gatsby blog starter](https://github.com/gatsbyjs/gatsby-starter-blog "gatsby blog starter"), you are good to go also._
...
Make sure you follow our social pages and endeavour to share this post.
