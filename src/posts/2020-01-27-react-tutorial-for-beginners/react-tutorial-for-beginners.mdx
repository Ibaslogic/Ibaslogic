...
Today, most of the web technologies that developers and site owners now embraced are built on React. From the [Gatsby site](/blog/gatsby-tutorial-from-scratch-for-beginners/ "Gatsby tutorial") to [WordPress custom blocks](https://wordpress.org/gutenberg/ "WordPress custom blocks") in the new Gutenberg post editor.
