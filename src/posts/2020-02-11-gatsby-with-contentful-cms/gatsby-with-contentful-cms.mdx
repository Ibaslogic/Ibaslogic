...
Pay attention to the `component` parameter that points to the template file that you need to create in the `src` directory. 

So let’s quickly create that file.
