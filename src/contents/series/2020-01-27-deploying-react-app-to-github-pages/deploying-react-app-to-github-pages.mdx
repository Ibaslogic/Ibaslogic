...
dateUpdated: "2021-01-13 10:32:00"
...
<PostSeriesLink
  label="This React tutorial is part 11 of 11 in the React for beginners series."
  datas={[
    {
      prefix: "Part 1",
...
In case you missed it, here is [the React application](https://ibaslogic.github.io/project-folder/ "simple react app") and the [source code](https://github.com/Ibaslogic/project-folder "simple react app GitHub repo").

<PostNextUnit
  heading="Next part: Making HTTP Request in React and understanding the lifecycle methods"
  btnLabel="continue"
